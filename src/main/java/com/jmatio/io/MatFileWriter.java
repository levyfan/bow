...
public class MatFileWriter {
    ...
    private void writeMatrix(DataOutputStream output, MLArray array) throws IOException {
        ...
        /***/
        File tempFile = new File("/tmp", String.valueOf(System.currentTimeMillis()));
        CountingOutputStream baos = new CountingOutputStream(new FileOutputStream(tempFile));
        /***/
        ...
        /***/
        baos.close();
        output.writeInt((int) baos.getCount()); //size of matrix
        FileInputStream fis = new FileInputStream(tempFile);
        IOUtils.copy(fis, output); //matrix data
        fis.close();
        /***/
    }
