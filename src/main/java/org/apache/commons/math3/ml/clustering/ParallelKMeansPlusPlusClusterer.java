 ...
 * @since 3.2
 */
public class ParallelKMeansPlusPlusClusterer<T extends Clusterable> extends Clusterer<T> {
                ...
                if (cluster.getPoints().isEmpty()) {
                    switch (emptyStrategy) {
                        case LARGEST_VARIANCE:
                            newCenter = getPointFromLargestVarianceCluster(finalClusters);
                            break;
                        case LARGEST_POINTS_NUMBER:
                            newCenter = getPointFromLargestNumberCluster(finalClusters);
                            break;
                        case FARTHEST_POINT:
                            newCenter = getFarthestPoint(finalClusters);
                            break;
                        default:
