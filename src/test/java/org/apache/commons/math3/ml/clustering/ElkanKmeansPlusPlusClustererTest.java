...
public class ElkanKmeansPlusPlusClustererTest {
    ...
    public void emptyInputPointsList() {
        final ElkanKmeansPlusPlusClusterer<DoublePoint> clusterer = new ElkanKmeansPlusPlusClusterer<>(10);
        clusterer.cluster(Collections.emptyList());
    }
    ...
    static private List<DoublePoint> generatePoints(int n, int d) {
        ...
        final UncorrelatedRandomVectorGenerator rnd = new UncorrelatedRandomVectorGenerator(d, new UniformRandomGenerator(new JDKRandomGenerator()));
    ...
    public static void main(String[] args) {
        ...
        PerfTestUtils.timeAndReport("kmeans comparison", 3, 3, false,
                new PerfTestUtils.RunTest[]{
                        new KmeansRunTest("elkan kmeans++, k=20, d=5", new ElkanKmeansPlusPlusClusterer<>(20), points_d5),
                        new KmeansRunTest("elkan kmeans++, k=20, d=10", new ElkanKmeansPlusPlusClusterer<>(20), points_d10),
                        new KmeansRunTest("elkan kmeans++, k=20, d=20", new ElkanKmeansPlusPlusClusterer<>(20), points_d20),
                        new KmeansRunTest("parallel kmeans++, k=20, d=5", new ParallelKMeansPlusPlusClusterer<>(20), points_d5),
                        new KmeansRunTest("parallel kmeans++, k=20, d=10", new ParallelKMeansPlusPlusClusterer<>(20), points_d10),
                        new KmeansRunTest("parallel kmeans++, k=20, d=20", new ParallelKMeansPlusPlusClusterer<>(20), points_d20),
                });
