...
public class ParallelKMeansPlusPlusClustererTest {
    ...
    public void testPerformClusterAnalysisDegenerate() {
        ParallelKMeansPlusPlusClusterer<DoublePoint> transformer =
                new ParallelKMeansPlusPlusClusterer<>(1, 1);
    ...
    public void testCertainSpace() {
        ParallelKMeansPlusPlusClusterer.EmptyClusterStrategy[] strategies = {
                ParallelKMeansPlusPlusClusterer.EmptyClusterStrategy.LARGEST_VARIANCE,
                ParallelKMeansPlusPlusClusterer.EmptyClusterStrategy.LARGEST_POINTS_NUMBER,
                ParallelKMeansPlusPlusClusterer.EmptyClusterStrategy.FARTHEST_POINT
        };
        for (ParallelKMeansPlusPlusClusterer.EmptyClusterStrategy strategy : strategies) {
            ...
            for (int n = 2; n < 27; ++n) {
                ParallelKMeansPlusPlusClusterer<DoublePoint> transformer =
                        new ParallelKMeansPlusPlusClusterer<>(n, 100, new EuclideanDistance(), random, strategy);
    ...
    public void testSmallDistances() {
        ...
        ParallelKMeansPlusPlusClusterer<DoublePoint> clusterer =
                new ParallelKMeansPlusPlusClusterer<>(NUM_CLUSTERS, NUM_ITERATIONS,
    ...
    public void testPerformClusterAnalysisToManyClusters() {
        ParallelKMeansPlusPlusClusterer<DoublePoint> transformer =
                new ParallelKMeansPlusPlusClusterer<>(3, 1, new EuclideanDistance(), random);
